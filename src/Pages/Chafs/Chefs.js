...
const Chefs = () => {
    return (
        <div>
            <div className='AboutTopBanner mb-12 p-8 text-white lg:pl-14 lg:pt-28'>
                <h1 className=' text-6xl font-bold mb-3'>Meet our Chefs</h1>
                <p className=' text-lg text-amber-700'>HOME / CHEFS</p>
            </div>
            <div className=' container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-8'>
                ...
                <div className=' border rounded-lg'>
                    <div className='OurChefBG4 h-80 text-right text-white flex justify-end m-8 rounded-r-[50px] rounded-t-[50px] hover:rounded-tl-none hover:rounded-bl-[50px]'>
                        <div className=' text-4xl font-bold text-right my-auto bg-amber-500 p-2 rounded-l-lg'>
                            <FaFacebookSquare className=' my-3 hover:text-gray-100 hover:cursor-pointer' />
                            <FaTwitterSquare className=' my-3 hover:text-slate-100 hover:cursor-pointer' />
                            <FaLinkedin className=' my-3 hover:text-slate-100 hover:cursor-pointer' />
                ...
                <div className=' border rounded-lg'>
                    <div className='OurChefBG5 h-80 text-right text-white flex justify-end m-8 rounded-r-[50px] rounded-t-[50px] hover:rounded-tl-none hover:rounded-bl-[50px]'>
                        <div className=' text-4xl font-bold text-right my-auto bg-amber-500 p-2 rounded-l-lg'>
                            <FaFacebookSquare className=' my-3 hover:text-gray-100 hover:cursor-pointer' />
                            <FaTwitterSquare className=' my-3 hover:text-slate-100 hover:cursor-pointer' />
                            <FaLinkedin className=' my-3 hover:text-slate-100 hover:cursor-pointer' />
                    ...
                    <div className=' m-8'>
                        <h1 className=' text-2xl font-bold'>JIMMEY ROBERT</h1>
                        <h3 className='font-bold text-zinc-500'>03 YEAR EXPERIENCE</h3>
                    </div>
                </div>
                <div className=' border rounded-lg'>
                    <div className='OurChefBG6 h-80 text-right text-white flex justify-end m-8 rounded-r-[50px] rounded-t-[50px] hover:rounded-tl-none hover:rounded-bl-[50px]'>
                        <div className=' text-4xl font-bold text-right my-auto bg-amber-500 p-2 rounded-l-lg'>
                            <FaFacebookSquare className=' my-3 hover:text-gray-100 hover:cursor-pointer' />
                            <FaTwitterSquare className=' my-3 hover:text-slate-100 hover:cursor-pointer' />
                            <FaLinkedin className=' my-3 hover:text-slate-100 hover:cursor-pointer' />
                    ...
                    <div className=' m-8'>
                        <h1 className=' text-2xl font-bold'>HOXAL DINO</h1>
                        <h3 className='font-bold text-zinc-500'>08 YEAR EXPERIENCE</h3>
                    </div>
                </div>
            </div>
        </div>
